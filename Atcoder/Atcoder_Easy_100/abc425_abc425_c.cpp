...
int fuck_them_all(const vi &amp;pref ,int l,int r){
        if(l&gt;r) return 0;
...
void solve1(){
    ...
    for (int i = 0; i &lt; m; i&#43;&#43;)
    {
        ...
        if(x==1){
            ...
            int b,c;cin&gt;&gt;b&gt;&gt;c;
            int start=(int)(rot&#43;b-1)%n;
            int end=(int)(rot&#43;c-1)%n;   
        
            int ans=0;
            if(start&lt;=end){
                ans=fuck_them_all(pref,start,end);
            }else{
                ans =fuck_them_all(pref,start,n-1) &#43;fuck_them_all(pref,0,end);
            }
            cout&lt;&lt;ans&lt;&lt;&#39;\n&#39;;
        }
    }
